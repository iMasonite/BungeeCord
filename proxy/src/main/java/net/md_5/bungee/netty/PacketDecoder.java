...
/** This class will attempt to read a packet from {@link PacketReader}, with the specified
 * {@link #protocol} before returning a new {@link ByteBuf} with the copied contents of
 * all bytes read in this frame.
 * <p/>
 * It is based on {@link ReplayingDecoder} so that packets will only be returned when all
 * needed data is present. */
@AllArgsConstructor
