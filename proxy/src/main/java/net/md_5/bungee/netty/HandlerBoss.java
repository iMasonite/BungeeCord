...
/** This class is a primitive wrapper for {@link PacketHandler} instances tied to channels
 * to maintain simple states, and only call the required, adapted methods when the channel
 * is connected. */
