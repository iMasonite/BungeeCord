...
public class ServerConnector extends PacketHandler {
	...
	public void handle(PacketFAPluginMessage pluginMessage) throws Exception {
		if (pluginMessage.equals(PacketConstants.I_AM_BUNGEE)) { throw new IllegalStateException("May not connect to another BungeCord!"); }
		...
		user.unsafe().sendPacket(pluginMessage); // We have to forward these to the user,
																							// especially with Forge as stuff might
																							// break
