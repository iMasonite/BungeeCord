...
public class Metrics extends TimerTask {
	...
	private void postPlugin(boolean isPing) throws IOException {
		...
		if (response == null || response.startsWith("ERR")) { throw new IOException(response); // Throw
																																														// the
																																														// exception
		}
	}
	...
	/** <p>
	 * Encode a key/value data pair to be used in a HTTP post request. This INCLUDES a & so
	 * the first key/value pair MUST be included manually, e.g:
	 * </p>
	 * <code>
