...
public class Plugin {
	 ...
	 * initialized, so only use it for registering {@link ConfigurationAdapter}'s and other
	 * predefined behavior. */
	public void onLoad() {}
	...
	/** Gets the data folder where this plugin may store arbitrary data. It will be a child
	 * of {@link ProxyServer#getPluginsFolder()}.
	 * 
	...
	/** Get a resource from within this plugins jar or container. Care must be taken to close
	 * the returned stream.
	 * 
