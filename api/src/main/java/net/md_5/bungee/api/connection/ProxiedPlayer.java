...
/** Represents a player who's connection is being connected to somewhere else, whether it
 * be a remote or embedded server. */
public interface ProxiedPlayer extends Connection, CommandSender {
	...
	/** Sets this players display name to be used as their nametag and tab list name.
	 * 
	 * @param name the name to set */
	void setDisplayName(String name);
	
	/** Connects / transfers this user to the specified connection, gracefully closing the
	 * current one. Depending on the implementation, this method might return before the
	...
	/** Sets the new tab list for the user. At this stage it is not advisable to change after
