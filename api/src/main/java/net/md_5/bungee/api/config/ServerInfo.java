...
public interface ServerInfo {
	...
	/** Gets the connectable host + port pair for this server. Implementations expect this to
	 * be used as the unique identifier per each instance of this class.
	 * 
	...
	/** Whether the player can access this server. It will only return false when the player
	 * has no permission and this server is restricted.
	 * 
