...
/** This class allows plugins to set their own configuration adapter to load settings from
 * a different place. */
public interface ConfigurationAdapter {
	...
	/** Get all permission corresponding to the specified group. The result of this method
	 * may or may not be cached, depending on the implementation.
	 * 
