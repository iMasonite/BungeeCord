...
public class AsyncEvent<T> extends Event {
	...
	/** Register an intent that this plugin will continue to perform work on a background
	 * task, and wishes to let the event proceed once the registered background task has
	 * completed.
	 * 
	...
	/** Notifies this event that this plugin has done all its required processing and wishes
