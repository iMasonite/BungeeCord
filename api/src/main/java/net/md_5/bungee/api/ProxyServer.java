...
public abstract class ProxyServer {
	...
	public abstract boolean alreadyConnectedMsg(String playerName);
	
	public abstract boolean alreadyConnectingMsg(String playerName);
	...
	/** Return all servers registered to this proxy, keyed by name. Unlike the methods in
	 * {@link ConfigurationAdapter#getServers()}, this will not return a fresh map each
	 * time.
	 * 
	...
	/** Get the {@link PluginManager} associated with loading plugins and dispatching events.
	 * It is recommended that implementations use the provided PluginManager class.
	 * 
	...
	/** Set the configuration adapter to be used. Must be called from {@link Plugin#onLoad()}
	 * .
	 * 
	 ...
	 * 
	 * @throws Exception any exception thrown during startup causing the instance to fail to
	 *         boot */
	public abstract void start() throws Exception;
	
	/** Register a channel for use with plugin messages. This is required by some server /
	...
	/** Returns the console overlord for this proxy. Being the console, this command server
	 * cannot have permissions or groups, and will be able to execute anything.
	 * 
	...
	/** Gets the the web client used by this proxy to facilitate making web requests. Care
	 * should be taken to ensure that all operations are non blocking where applicable.
	 * 
	 * @return the server's {@link AsyncHttpClient} instance */
	public abstract AsyncHttpClient getHttpClient();
	
	/** Get the current number of connected users. The default implementation is more
	 * efficient than {@link #getPlayers()} as it does not take a lock or make a copy.
	 * 
