...
public interface TabListHandler {
	...
	/** Called so that this class may set member fields to keep track of its internal state.
	 * You should not do any packet sending or manipulation of the passed player, other than
	 * storing it.
	 * 
	...
	/** Called when a players ping changes. The new ping will have not updated in the player
	 * instance until this method returns.
	 * 
